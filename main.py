...
<div style="background-color:#120e11;width:100%;display:flex;flex-direction:column;align-items:center;font-family:Georgia,serif;padding-bottom:32px;position:relative;overflow:hidden;">
  ...
  <div style="width:100%;max-width:800px;background:#1e1620;border-radius:10px;overflow:hidden;border:0.5px solid rgba(176,122,144,0.13);margin:8px 0;position:relative;z-index:1;">
  ...
  <div style="background:rgba(176,122,144,0.05);color:#9a7888;padding:10px 16px;border-radius:10px;max-width:800px;width:100%;font-size:13px;font-style:italic;line-height:1.9;text-align:center;margin-bottom:12px;position:relative;z-index:1;">{scene}</div>
  <div style="background:rgba(255,255,255,0.03);color:#f0dce8;padding:16px 18px;border-radius:15px;max-width:800px;width:100%;line-height:1.85;font-size:1em;margin-bottom:12px;position:relative;z-index:1;">{story}</div>
  <details style="width:100%;max-width:800px;margin-bottom:8px;position:relative;z-index:1;">
